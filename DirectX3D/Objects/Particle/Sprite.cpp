...
Sprite::Sprite(wstring imageFile, float width, float height, UINT frameX, UINT frameY, bool isAdditive)
	:size(width, height)
{
	...
	buffer->Get().maxFrame = { (float)frameX, (float)frameY };
	maxFrameCount = frameX * frameY;
